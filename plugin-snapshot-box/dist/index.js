...
// src/service.ts
var SnapshotService = class _SnapshotService extends Service {
  constructor(runtime) {
    super();
  ...
  static async start(runtime) {
    const service = new _SnapshotService(runtime);
  ...
  async fetchProposals() {
    try {
      ...
      `;
      const response = await lib_default(this.apiUrl, {
        method: "POST",
...
// src/providers/proposals.ts
var snapshotProposalsProvider = {
  name: "snapshotProposals",
  description: "Provides open Snapshot proposals for yam.eth",
  async get(runtime) {
    const snapshotService = runtime.getService("SnapshotService");
    if (!snapshotService) {
...
var index_default = snapshotProposalsPlugin;
export {
